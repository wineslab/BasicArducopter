...
def main():
    """
    Nicholas experiment with a hard-coded offset of 2.5m with the BasicArdu wrapper
    """
    ...
    drone.handle_waypoint(Frames.NED, 2.5, 0, drone_height, 0)
    ...
    drone.handle_waypoint(Frames.NED, 5, 0, drone_height, 0)
    ...
    drone.handle_waypoint(Frames.NED, 7.5, 0, drone_height, 0)
